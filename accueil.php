	...
	<div class="right-sidebar">
		...
		<div class="right-sidebar-body customscroll">
			<div class="right-sidebar-body-content">
				<h4 class="weight-600 font-18 pb-10">Style d'en-tête</h4>
				<div class="sidebar-btn-group pb-30 mb-10">
					<a href="javascript:void(0);" class="btn btn-outline-primary header-white active">Eclairé</a>
					<a href="javascript:void(0);" class="btn btn-outline-primary header-dark">Sombre</a>
				</div>

				<h4 class="weight-600 font-18 pb-10">Style de menu</h4>
				<div class="sidebar-btn-group pb-30 mb-10">
					<a href="javascript:void(0);" class="btn btn-outline-primary sidebar-light ">Eclairé</a>
					<a href="javascript:void(0);" class="btn btn-outline-primary sidebar-dark active">Sombre</a>
				</div>

				<h4 class="weight-600 font-18 pb-10">Style d'icon menu déroulant</h4>
				...
				<div class="reset-options pt-30 text-center">
					<button class="btn btn-danger" id="reset-settings">Réglage par defeault</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
					    ...
					    <div class="weight-600 font-30 text-blue">Checking</div>
						</h4>
